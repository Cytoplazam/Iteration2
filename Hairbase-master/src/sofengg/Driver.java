...
public class Driver {
    public static void main(String[] args) {
        ...
        do {
            do {
                ...
                System.out.println("[4] - Compute Total Company Share");
                System.out.println("[5] - Exit");

                try {
                    userInput = scan.nextInt();
                    if (userInput <= 0 || userInput > 5)
                        System.out.println("\nInput must be a number from 1-5");
    ...
    public static void computeCompanyShare() {
        BigDecimal SSS = new BigDecimal(0.0);
        BigDecimal PH = new BigDecimal(0.0);
        ...
        do {
            ...
            switch(userInput) {
                case 1:
                    do {
                        try {
                            System.out.println("\nEnter the Amount of the SSS Contribution: ");
                            amount = scan.nextBigDecimal();
                            if (amount.compareTo(z) == -1 || amount.compareTo(z) == 0)
                    ...
                    } while (amount.compareTo(z) == -1 || amount.compareTo(z) == 0);
                    SSS = SSS.add(amount);
                    PH = PH.add(y);
                    PI = PI.add(y);
                    break;
